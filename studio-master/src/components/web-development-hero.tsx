...
const TrustElements: React.FC = () => {
  const avatars = [
    { src: "https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg?auto=compress&cs=tinysrgb&w=100", hint: "team meeting" },
    { src: "https://images.pexels.com/photos/3184418/pexels-photo-3184418.jpeg?auto=compress&cs=tinysrgb&w=100", hint: "business discussion" },
    { src: "https://images.pexels.com/photos/3183197/pexels-photo-3183197.jpeg?auto=compress&cs=tinysrgb&w=100", hint: "office collaboration" },
    { src: "https://images.pexels.com/photos/1181406/pexels-photo-1181406.jpeg?auto=compress&cs=tinysrgb&w=100", hint: "woman presentation" },
  ];
  ...
  return (
    <div className="inline-flex items-center space-x-3 bg-background/60 border border-border backdrop-blur-sm rounded-full py-2 px-3 sm:py-2 sm:px-4 text-xs sm:text-sm">
      ...
      <p className="text-foreground animate-appear whitespace-nowrap font-sans" style={{ animationDelay: '800ms' }}>
        <span className="text-foreground font-semibold">Trusted by</span> Global Brands & Enterprises
      </p>
    </div>
  );
};
      ...
      <div className="relative z-10 text-center w-full max-w-4xl mx-auto flex flex-col items-center justify-center flex-grow py-8 sm:py-16">
        ...
        <div className="mb-6 sm:mb-10 px-4 max-w-2xl">
          <p className="text-[clamp(1rem,2.5vw,1.25rem)] text-muted-foreground leading-relaxed animate-appear delay-300 font-sans">
            We build fast, responsive, and scalable web applications tailored to your business needs, helping you achieve your digital goals.
          </p>
        </div>
